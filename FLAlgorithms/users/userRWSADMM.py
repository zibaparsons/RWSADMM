        ...
        for epoch in range(1, self.local_epochs + 1):  # local update
            ...
            for i in range(self.K):
                ...
                for param_x, param_x_old, param_z_old, param_y, param_z in zip(self.local_model_x.parameters(), \
                    ...
                    param_x.data = param_y.data - self.learning_rate * (param_x.grad.data - param_z.data + eps) #* param_x.grad.data #
                    param_z.data = param_z.data + self.beta / self.learning_rate * (param_x.data - param_y.data - eps)
                    param_y.data = param_y.data + 1 / num_users * (
                            param_x.data - param_z.data * self.learning_rate - param_x_old.data + param_z_old.data * self.learning_rate)
